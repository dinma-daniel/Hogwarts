    ...
    <x-slot name="header">
        <div class="flex align-middle justify-between">
            ...
            <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                <a href="{{ route('books') }}" class="rounded-md bg-gray-100 px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-sky-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Borrow a Book</a>
            </div>
        </div>
    </x-slot>
